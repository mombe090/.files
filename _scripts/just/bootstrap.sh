...
echo "Next steps:"
echo ""
echo "  1. See available commands:"
echo "     ${BOLD}just --list${NC}"
echo ""
echo "  2. Install dotfiles (full):"
echo "     ${BOLD}just install_full${NC}"
echo ""
echo "  3. Install dotfiles (minimal):"
echo "     ${BOLD}just install_minimal${NC}"
echo ""
echo "  4. Check system health:"
echo "     ${BOLD}just doctor${NC}"
echo ""
echo "For more help:"
echo "  just help"
echo "  cat README.md"
