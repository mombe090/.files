...
EXTERNAL_MONITOR="DP-1"                   # Your external display name (this system uses DP-3)
EXTERNAL_RESOLUTION="3840x2560@60"        # External monitor resolution@refresh
LAPTOP_RESOLUTION="1920x1200@60"          # Laptop monitor resolution@refresh
EXTERNAL_SCALE="1.60"                     # External monitor scaling factor (DP-3 scale)
LAPTOP_SCALE="1"                           # Laptop monitor scaling factor
EXTERNAL_POSITION="0x0"                   # External monitor position
LAPTOP_POSITION_DUAL="2400x0"            # Laptop position in dual mode (3840 / 1.60 = 2400)
